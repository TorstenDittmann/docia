...
export async function serveStaticRequest(options: ServeStaticRequestOptions): Promise<Response> {
	...
	const isVersionedSearchIndex =
		resolved.relativePath === "search-index.json" && url.searchParams.has("v");
